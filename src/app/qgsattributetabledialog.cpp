...
QgsAttributeTableDialog::QgsAttributeTableDialog( QgsMapLayer *layer, QgsAttributeTableFilterModel::FilterMode initialMode, QWidget *parent, Qt::WindowFlags flags )
  : QDialog( parent, flags )

{
  if ( layer->type() == QgsMapLayerType::RasterLayer ){
     QString vatFile = QFileInfo(layer->source()).absoluteFilePath();
     vatFile += QStringLiteral( ".vat.dbf" );
     mLayer = new QgsVectorLayer( vatFile );
  }else{
