/***************************************************************************
    qgsproviderconfigwidgetfactory.h
     --------------------------------------
    Date                 : 2020
...
#ifndef QGSPROVIDERCONFIGWIDGETFACTORY_H
#define QGSPROVIDERCONFIGWIDGETFACTORY_H
 ...
 * \since QGIS 2.16
 */
class GUI_EXPORT QgsProviderConfigWidgetFactory
{
  public:

    //! Constructor
    QgsProviderConfigWidgetFactory() = default;

    //! Constructor
    QgsProviderConfigWidgetFactory( const QString &title, const QIcon &icon );

    virtual ~QgsProviderConfigWidgetFactory() = default;
...
#endif // QGSPROVIDERCONFIGWIDGETFACTORY_H
